...
import style from "./style/navList.module.css";
      ...
      <div className={style.menu}>
          ...
          <ul>
            <Link href="/home">
              <li className={style.menuItem}>
                ...
                <span
                  ...
                  style={nowPage === "home" ? { fontWeight: 700 } : {}}
                >
                  홈
                </span>
              </li>
            ...
            <Link href="/explore">
              <li className={style.menuItem}>
                ...
                <span
                  className={style.menuText}
                  style={nowPage === "explore" ? { fontWeight: 700 } : {}}
                >
                  탐색하기
                </span>
              </li>
            ...
            <Link href="/messages">
              <li className={style.menuItem}>
                ...
                <span
                  className={style.menuText}
                  style={nowPage === "messages" ? { fontWeight: 700 } : {}}
                >
                  쪽지
                </span>
              </li>
            ...
            <Link href="/richdad">
              <li className={style.menuItem}>
                ...
                <span
                  className={style.menuText}
                  style={nowPage === "richdad" ? { fontWeight: 700 } : {}}
                >
                  프로필
                </span>
              </li>
        ...
        <Link href="/compose/tweet">
          <div className={style.actionButton}>
            <span className={style.iconInButton}>
            ...
            <span className={style.textInButton}>게시하기</span>
          </div>
        </Link>
      </div>
      <div className={style.logoutDiv}>
        <Link className={style.logout} href="/logout">
          ...
          <div className={style.logoutTextDiv}>
            <p className={style.logoutTitle}>{user.username}</p>
            <p className={style.logoutBody}>@{user.userId}</p>
          </div>
        </Link>
      </div>
    </>
